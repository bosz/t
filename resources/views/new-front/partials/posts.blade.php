...
<div class="box pst oneBox" style="width:100%; float:left; position:relative; margin:0px;">
    ...
    <div class="center">
        ...
        <div class="icons iconss">
            <span class="leftIcon" style="width:35%;"><i class="fa fa-ban" ></i>&nbsp;
			 <a href="{{url('post/'.$post[0]->id)}}"><img src="{{URL::asset('images/1484179391_back.png')}}" width="18">&nbsp;<span style="color:#3d3d3d;font-size:13px !important">partager</span></a></span>
...
<div class="twoBoxes">
    ...
    <div class="box box2 pst" style="float:left;">
        ...
        <div class="center">
            ...
            <div class="icons">
                <span class="leftIcon" style="width:35%;"><i class="fa fa-ban" ></i>&nbsp;
			 <a href="{{url('post/'.$post[1]->id)}}"><img src="{{URL::asset('images/1484179391_back.png')}}" width="18">&nbsp;<span style="color:#3d3d3d;font-size:13px !important">partager</span></a></span>
    ...
    <div class="box box2 pst" style="float:right;">
        ...
        <div class="center">
            ...
            <div class="icons">
                <span class="leftIcon" style="width:35%;"><i class="fa fa-ban" ></i>&nbsp;
				<a href="{{url('post/'.$post[2]->id)}}"><img src="{{URL::asset('images/1484179391_back.png')}}" width="18">&nbsp;<span style="color:#3d3d3d;font-size:13px !important">partager</span></a></span>
